...
reflactive_index[10:16, :] = 1.5
reflactive_index[10, 0:10] = 1
reflactive_index[10, 40:50] = 1
reflactive_index[16, 0:10] = 1
reflactive_index[16, 40:50] = 1
reflactive_index[11, 0:20] = 1
reflactive_index[11, 30:50] = 1
reflactive_index[15, 0:20] = 1
reflactive_index[15, 30:50] = 1

# シミュレーションの初期化
space = Space(wall=wall, reflactive_index=reflactive_index)
wave = WaveClass(amplitude=10, wavelength=2, frequency=1, E0=np.zeros([size, size]), E1=np.zeros([size, size]))
t = 0

# 初期条件
wave.waves[1][1][size//2] = wave.amplitude*math.sin(wave.wavenumber*dx - wave.angular_frequency*dt)

# メイン関数
def main():
    make_gif("./WaveSim/wave/wave.gif")
